...
public class VideoDetailsFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<String> {
...
//    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            animeUrl = getArguments().getString(Constants.ANIME_URL);
            anime = MAVApplication.getInstance().getRepository().getAnimeByUrl(animeUrl);
            episodeUrl = getArguments().getString(Constants.EPISODE_URL);
...
//            loadingImageView.setVisibility(View.GONE);
            ...
            //TODO
            if (episode != null)
                getLoaderManager().initLoader(VideoDetailsFragment.class.getSimpleName().hashCode(), null, this);
            else {
