...
import com.taskdesignsinc.android.myanimeviewer.recyclerview.animator.holder.AnimateViewHolder;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        final ViewPropertyAnimator animation = ViewPropertyAnimator.animate(view);
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            final ViewPropertyAnimator oldViewAnim =
                    ViewPropertyAnimator.animate(view).setDuration(getChangeDuration());
        ...
        if (newView != null) {
            ...
            final ViewPropertyAnimator newViewAnimation = ViewPropertyAnimator.animate(newView);
    ...
    private static class VpaListenerAdapter implements Animator.AnimatorListener {
